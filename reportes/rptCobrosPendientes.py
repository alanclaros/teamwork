...
def myFirstPage(canvas, doc):
    ...
    datosReporte['titulo'] = 'Cobros Pendientes ' + DATO_CAJA
...
def rptCobrosPendientes(buffer_pdf, usuario, bloque_id, piso_id, periodo_ini, periodo_fin):
    # pdf
    ...
    datos_reporte = reporte_controller.datos_cobros_pendientes(usuario, bloque_id, piso_id, periodo_ini, periodo_fin)
    # print(datos_reporte)
    ...
    data.append(['Periodo', 'Bloque', 'Piso', 'Dpto', 'Pendiente'])
    ...
    for dato in datos_reporte:
        ...
        datos_tabla = [dato['periodo'], bloque, piso, departamento, str(dato['monto_bs'])]
    ...
    tabla_datos = Table(data, colWidths=[30*mm, 30*mm, 30*mm, 30*mm, 25*mm], repeatRows=1)
